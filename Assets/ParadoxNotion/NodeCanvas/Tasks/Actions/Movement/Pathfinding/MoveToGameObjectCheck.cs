...
namespace NodeCanvas.Tasks.Actions
{
    ...
    [Name("Seek (GameObject And Check)")]
    [Category("Movement/Pathfinding")]
    public class MoveToGameObjectCheck : ActionTask<NavMeshAgent>
    {
        ...
        public BBParameter<float> rangeDistance = 0.1f;
        ...
        protected override void OnUpdate()
        {
            ...
            if (distance > rangeDistance.value)
            {
                EndAction(true);
            }
        }
